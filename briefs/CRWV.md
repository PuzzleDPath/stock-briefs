...
Microsoft 67% concentration + กำลังสร้าง Maia 100 in-house = single point of failure ที่ใหญ่เกินไป Debt $14.7B + capex $31–35B ปีนี้ + interest run-rate $2B+/ปี ทำให้ buffer얇มาก คำถามใน "What to ask" ยังตอบไม่ได้หลายข้อ ไม่เหมาะกับมือใหม่ที่ต้องเข้าใจก่อนซื้อ
...
- Leverage สูงมากจนคล้าย pattern ที่เคยเจ็บมาแล้ว — บริษัทต้องการ capital market สนับสนุนต่อเนื่อง ถ้า sentiment เปลี่ยนโครงสร้างสั่น
- ยังตอบ 5 คำถามใน "What to ask" ไม่ได้เลย — ตาม rule ของตัวเองคือ "ไม่ซื้อถ้ายังตอบคำถามตัวเองไม่ได้หมด"

**Portfolio fit:** NVDA + AVGO expose AI infra wave อยู่แล้ว CRWV ซ้อน exposure เดิมในรูปแบบที่มีหนี้และ concentration risk สูงกว่ามาก ถ้าอยากเพิ่ม AI infra — DCA เพิ่มใน position ที่เข้าใจ thesis แล้วน่าจะ make sense กว่า
