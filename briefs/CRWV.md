...
- Revenue $2.1B (+112% YoY, +32% QoQ) (source: sources/CRWV/q-latest-call.md)
- Adjusted EBITDA $1.2B (margin 56%) +91% YoY; Adjusted Operating Income $21M (margin 1%) (source: sources/CRWV/q-latest-call.md)
- Net loss GAAP ($740M); interest expense $536M ใน Q1 เดียว (source: sources/CRWV/q-latest-call.md)
- Contracted backlog (RPO) $99.4B (+50% QoQ, ~4x YoY) — ลูกค้า 10 รายที่ commit $1B+ แต่ละราย; financial services (Jane Street, Hudson River Trading) ใกล้ $10B (source: sources/CRWV/q-latest-call.md)
- Cash $3.3B (source: sources/CRWV/q-latest-call.md)
- Guidance Q2 2026: revenue $2.45–2.6B, Adj. Op. Income $30–90M, interest expense $650–730M, capex $7–9B (source: sources/CRWV/q-latest-call.md)
- Guidance FY2026: revenue $12–13B (reaffirmed), Adj. Op. Income $900M–$1.1B, Exit ARR $18–19B (floor raised $1B), capex $31–35B (source: sources/CRWV/q-latest-call.md)
- 2027 target: $30B+ annualized run-rate revenue, 75%+ contracted ไว้แล้ว (source: sources/CRWV/q-latest-call.md)
...
**Source files ที่ตรวจ:** `sources/CRWV/10-k-latest.md`, `sources/CRWV/q-latest-call.md`, `sources/CRWV/news-latest.md`
