...
- **Margin — ลดชั่วคราว แต่ฟื้นแล้ว:** Gross margin GAAP FY2026 ลดจาก 75.0% เหลือ 71.1% จาก Hopper→Blackwell transition + H20 inventory loss $4.5B; Q1 FY2027 non-GAAP ฟื้นกลับ 75% แล้ว (source: 10-k-latest.md, q1fy27-call.md)
...
- **Capital allocation — FCF สูงมาก:** FCF FY2026 $96.6B; Q1 FY2027 FCF $49B (จาก $35B ไตรมาสก่อน); buyback FY2026 $40.1B + ปันผล $974M; remaining authorization $58.5B หลัง FY2026 + new $80B ใน Q1 FY2027 (source: 10-k-latest.md, q1fy27-call.md)
...
- Revenue $82B +85% YoY +20% QoQ — ไตรมาสที่ 14 ติดกันที่โต QoQ (source: sources/NVDA/q1fy27-call.md)
- Data Center $75B (92% of total) +92% YoY — computing $60B, networking $15B (nearly tripled YoY) (source: sources/NVDA/q1fy27-call.md)
- Hyperscale subsegment $38B; ACIE (AI Cloud, Industrial, Enterprise) $37B +31% QoQ (source: sources/NVDA/q1fy27-call.md)
- Non-GAAP gross margin 75%; FCF $49B (จาก $35B ไตรมาสก่อน); returned $20B to shareholders; ปันผลขึ้นจาก $0.01 → $0.25/share (source: sources/NVDA/q1fy27-call.md)
- Q2 FY2027 guidance: $91B ±2%, non-GAAP gross margin 75% ±50 bps (GAAP 74.9%), GAAP OpEx ~$8.5B; China data center compute ไม่รวมใน guidance (ไม่มี H200 shipment) (source: sources/NVDA/q1fy27-call.md)
...
- **Blackwell ramp** — throughput 2.7x, cost-per-token ลด 60% ใน 6 เดือน (ตัวเลขจาก NVDA เอง ยังไม่มี independent benchmark); H100 cloud rental prices +20% YoY สะท้อน demand layer ที่ยังแน่น (source: q1fy27-call.md)
- **TAM expansion** — Vera CPU เปิด addressable market ~$200B, standalone CPU revenue projected $20B ปีนี้ (marketing claim — ยังไม่มี revenue จริง ต้องติดตาม); sovereign AI 40+ ประเทศโต 80%+ YoY (ไม่มีตัวเลขฐาน absolute) (source: q1fy27-call.md)
...
**Source files:** sources/NVDA/10-k-latest.md (FY2026 10-K, fetched 2026-06-07), sources/NVDA/q1fy27-call.md (Q1 FY2027, fetched 2026-06-07), sources/NVDA/news-latest.md (fetched 2026-06-30)
