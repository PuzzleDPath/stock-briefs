...
- **FCF ขึ้นต่อเนื่อง** — FCF FY2025 $1.07B (record); Q1 FY2027 FCF $468M (34% of revenue, all-time quarterly high); FY2027 FCF floor 30%+ guided (source: sources/CRWD/10-k-latest.md, sources/CRWD/q-latest-call.md)
...
- **GAAP กลับมาเป็นบวก** — GAAP net income $27.8M Q1 FY2027 (พลิกจาก loss FY2025 ที่เกิดจาก July 2024 outage); non-GAAP op margin 24%; Rule of 40 = 59 (source: sources/CRWD/q-latest-call.md)

---

## 3. Latest earnings (Q1 FY2027 — reported June 3, 2026)

- Revenue $1.39B (+26% YoY); net new ARR $256M (+32% YoY) (source: sources/CRWD/q-latest-call.md)
- Non-GAAP GM 79% record Q1; non-GAAP op income $326M (+62% YoY, 24% margin); EPS $1.10 beat consensus $0.88 (~25% beat) (source: sources/CRWD/q-latest-call.md)
- FCF $468M (34% of revenue all-time high); GAAP net income $27.8M; cash $4.55B (source: sources/CRWD/q-latest-call.md)
- Falcon Flex $1.9B ARR (+99% YoY), 300+ accounts ใหม่; Next-Gen SIEM $600M+ ARR; AIDR ARR +250%+ sequential; cloud+identity+SIEM รวม $2B+ ARR (source: sources/CRWD/q-latest-call.md)
- FY2027 guidance raised: revenue $5.915-5.959B (+23-24%); net new ARR $1.279-1.303B (raised +$50M); FCF margin 30%+ floor (source: sources/CRWD/q-latest-call.md)
...
5. Stock split 4-for-1 ก.ค. 2026 — เป็น cosmetic ราคาหน้าจอจะเปลี่ยนเป็น ~¼ ของปัจจุบัน fundamental ไม่เปลี่ยน แต่ต้องรู้ไว้
