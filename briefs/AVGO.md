...
- Revenue รวม $22.2B (+48% YoY) เกิน guidance — ชิปฝั่ง AI $10.8B (+143% YoY) คิดเป็นเกือบครึ่งของรายได้บริษัท (source: sources/AVGO/q-latest-call.md)
- Semiconductor Solutions $15B (+79% YoY); Infrastructure Software $7.2B gross margin 93%, ARR +17% YoY (source: sources/AVGO/q-latest-call.md)
- Operating margin 67% (all-time high, +200 bps YoY); FCF $10.3B = 46% of revenue (source: sources/AVGO/q-latest-call.md)
- Guidance Q3 FY2026: revenue $29.4B (+84% YoY), AI semiconductor $16B (+200% YoY) — ถ้าทำได้จริงจะเป็น single quarter ที่ใหญ่ที่สุดของบริษัท (source: sources/AVGO/q-latest-call.md)
- CEO Hock Tan รายงาน AI bookings เกิน $30B ในไตรมาสเดียว เทียบกับ ship จริงแค่ $10.8B — backlog $73B+ demand visibility ยาวถึงปี 2028 (source: sources/AVGO/q-latest-call.md; backlog figure from: sources/AVGO/10-k-latest.md)
- FY2026 full-year AI target $56B; FY2027 target >$100B (source: sources/AVGO/q-latest-call.md)
...
2. **$73B+ backlog ใน section 3** — ตัวเลขถูกต้องแต่มาจาก 10-k-latest.md (FY2025 data) ไม่ใช่ q-latest-call.md — ปรับ dual citation แล้ว
